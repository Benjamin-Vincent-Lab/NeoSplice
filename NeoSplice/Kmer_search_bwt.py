...
parser.add_argument('--tumor_bwt', required=True, type=str, nargs='?', help='provide tumor bwt path here')
parser.add_argument('--normal_bwt', required=True, type=str, nargs='?', help='provide normal bwt path here')
parser.add_argument('--processors', required=True, type=str, nargs='?', help='provide number of processors to be used')
parser.add_argument('--max_length', required=True, type=str, nargs='?', help='provide maximum k-mer length')
parser.add_argument('--tumor_threshold', required=True, type=str, nargs='?', help='provide tumor threshold')
parser.add_argument('--normal_threshold', required=True, type=str, nargs='?', help='provide normal threshold')
parser.add_argument('--outdir', required=True, type=str, nargs='?', help='provide output directory')
