...
def main():
    ...
    parser.add_argument('--sample', required=True, type=str, nargs='?', help='The sample name')
    parser.add_argument('--chromosome', required=True, type=str, nargs='?', help='The chromosome')
    parser.add_argument('--bam_file', required=True, type=str, nargs='?', help='provide RNA-seq bam file path here')
    parser.add_argument('--gff_file', required=True, type=str, nargs='?', help='The GFF file path')
    parser.add_argument('--genome_fasta', required=True, type=str, nargs='?', help='The genome FASTA file path')
    parser.add_argument('--kmer_bam', required=True, type=str, nargs='?', help='The bam file storing kmer info')
    parser.add_argument('--splice_graph', required=True, type=str, nargs='?', help='The path to splice graph')
    parser.add_argument('--tumor_junction_file', required=True, type=str, nargs='?', help='The file storing tumor junctions')
    parser.add_argument('--normal_junction_file', required=True, type=str, nargs='?', help='The file storing normal junctions')
    parser.add_argument('--transcript_min_coverage', required=True, type=str, nargs='?', help='The minimum transcript coverage')
    parser.add_argument('--HLA_I', required=True, type=str, nargs='?', help='The class I HLA type')
    parser.add_argument('--HLA_II', type=str, nargs='?', help='The class II HLA type')
    parser.add_argument('--netMHCpan_path', required=True, type=str, nargs='?', help='The netMHCpan-4.0 path')
    parser.add_argument('--netMHCIIpan_path', type=str, nargs='?', help='The netMHCIIpan-3.2 path')
    parser.add_argument('--outdir', required=True, type=str, nargs='?', help='The output directory')
    parser.add_argument('--length_list', required=True, type=int, nargs='*', default=[8, 9, 10, 11], help='The output peptide lengths')
